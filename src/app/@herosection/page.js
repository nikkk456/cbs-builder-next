                ...
                <div className='col-md-6 d-flex flex-column justify-content-center align-items-center '>
                    ...
                    <div className='row mt-3'>
                        <div className='col-md-6 col-6'>
                            <button className='buttoncbs' style={{width:"170px"}} data-bs-toggle="modal" data-bs-target="#exampleModal">Request Call Back</button>
                        </div>
                        <div className='col-md-6 col-6'>
                            <button className='buttoncbs' style={{width:"170px"}} data-bs-toggle="modal" data-bs-target="#exampleModal">Download Brochure</button>
                        </div>
                    </div>
                </div>
