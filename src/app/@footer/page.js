    ...
    <div className='container' style={{ backgroundColor: "#3a5c5c", color: "white", maxWidth: "none", padding: "30px" }}>
      <div className='row'>
        <div className='col-md-6'>
          ...
          <div className='row'>
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d224633.65547854218!2d77.091676!3d28.392062!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d223bc0000001%3A0xf099c45e4463aa4c!2sAnant%20Raj%20Estate%20Plots!5e0!3m2!1sen!2sus!4v1708538970431!5m2!1sen!2sus" width="400" height="300" style={{ border: "0" }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title='cbsMap'>
            </iframe>
          </div>
        </div>
          ...
          <div className='row mt-3'>
            {loader ? <div className='d-flex justify-content-center align-items-center'>
              ...
              <form style={{ borderRadius: "10px", padding: "15px", boxShadow: "#c7c0c0 5px 3px 8px 2px", backgroundColor: "white", color: "black" }}>
                ...
                <button type="submit" className="buttoncbs" style={{ width: "100px" }} onClick={submitform}>Send Query</button>
                <button type="button" className="buttoncbs mx-2" style={{ width: "150px" }} onClick={submitform}>Book Free Site Visit</button>
              </form>}
